...
-- of generic structured XML documents into the Hughes/PeytonJones Doc
-- representation (which can later be rendered using Pretty.render).
-- See module Pretty for details of the pretty-printing combinators.
